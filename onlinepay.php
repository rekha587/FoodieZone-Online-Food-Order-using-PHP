...
<html>
  ...
  <head>
    <title> Online Payment | FoodieZone </title>
  </head>
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                <input type="number" class="form-control" placeholder="0000" required="" maxlength="4"/>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                <input type="number" class="form-control" placeholder="0000" required="" maxlength="4" />
                            </div>
                        ...
                        <div class="row ">
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                ...
                                <input type="number" class="form-control" placeholder="MM" required="" maxlength="2"/>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                <span class="help-block text-muted small-font">  Expiry Year</span>
                                <input type="number" class="form-control" placeholder="YY" required="" maxlength="2"/>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                <span class="help-block text-muted small-font">  CCV</span>
                                <input type="password" class="form-control" placeholder="CCV" required="" maxlength="3"/>
                            </div>
                        ...
                        <div class="row ">
                            <div class="col-md-12 pad-adjust">
                                ...
                                <input type="text" class="form-control" placeholder="Name On The Card" required=""  maxlength="20"/>
                            </div>
                        </div>
                        <br>
                        <div class="row">
